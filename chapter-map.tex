...
\begin{figure} [h]
  \begin{center}
    ...
    \caption{Configuração inicial da superfície a ser deformada.}\label{fig-eg-surf-deformer-1}
  \end{center}
\end{figure}
...
\begin{figure} [h]
  \begin{center}
    \includegraphics[width=350pt]{images/fig-eg-surf-deformer-2}
    \caption{Configuração deformada da superfície segundo as Lagrangeanas de 2ª ordem (a,d), 4ª ordem (b,e) e 6ª ordem (c, f).}\label{fig-eg-surf-deformer-2}
  \end{center}
\end{figure}

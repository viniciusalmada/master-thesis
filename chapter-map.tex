...
Neste capítulo será apresentado o conceito de linha de mapeamento presente no Sistema Recon, suas características, alguns casos de uso e também suas derivações.

Após isso, haverá uma abordagem acerca dos procedimentos matemáticos e algoritmos computacionais presentes no mapeamento de superfícies e de volume, com inclusão de exemplos e discussão a respeito dos resultados obtidos no contexto do que se propôs este trabalho.

...
A principal motivação desse trabalho se dá pela necessidade de realizar um acompanhamento mais detalhado da restauração estrutural sob um olhar tridimensional tendo por base a atividade que produz bons resultados a um custo baixo. Essa atividade, restauração de seções, é capaz de fornecer todas os dados para que se faça uma relação 2D para o espaço tridimensional, através do mapeamento de informações para superfícies e volume.

...
\acknowledgment{%
  \noindent Para que este trabalho fosse realizado eu tive ajuda e colaboração de várias pessoas e empresas às quais sou extremamente grato.
...
\begin{document}
  ...
  \input{4-chapter-map-surf}
  \input{5-chapter-map-vol}
  \input{6-conclusions}
  \arial
  \bibliography{tiny}
  \normalfont

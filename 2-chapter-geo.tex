...
Como dito, os blocos que formam a seção geológica possuem propriedades próprias que também precisam estar salvas na estrutura de dados topológica.
